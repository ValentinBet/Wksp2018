    ...
    if (!empty($_POST['aw'])) {
        ...
        if (($first + $second + $third) < 4 || ($first + $second + $third) > 4) {  // VALEUR A CHANGER SI RAJOUT DE QUESTIONS
            ...
            if ($first > $second && $first > $third) {
                ...
                echo '<strong>' . 'Vous avez autant de réponse 1 que 2' . '</strong>';  //TODO: Crée réponse(s) intermédiaire(s)
            }
            else if ($first = $third){
                echo '<strong>' . 'Vous avez autant de réponse 1 que 3' . '</strong>';  //TODO: Crée réponse(s) intermédiaire(s)
            }
            else if($second = $third) {
                echo '<strong>' . 'Vous avez autant de réponse 2 que 3' . '</strong>';  //TODO: Crée réponse(s) intermédiaire(s)
            }
